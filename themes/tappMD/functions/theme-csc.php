...
function cscstudio_setup() {
	...
	register_nav_menu( 'csc-theme-menu-top', __( 'CSC Top Navigation' , 'csc-theme') );
	register_nav_menu( 'csc-theme-mobile-nav', __( 'CSC Mobile Navigation' , 'csc-theme') );

	wp_create_nav_menu( 'CSC Main Navigation', array( 'slug' => 'csc-theme-menu-main' ) );
	wp_create_nav_menu( 'CSC Top Navigation', array( 'slug' => 'csc-theme-menu-top' ) );
	...
	wp_create_nav_menu( 'CSC Mobile Navigation', array( 'slug' => 'csc-theme-mobile-nav' ) );
...
function theme_csc_scripts() {
  ...
  wp_register_script( 'easing', get_template_directory_uri() . '/js/jquery.easing.1.3.min.js', array('jquery'),'', true);
  wp_register_script( 'jquerycycle', get_template_directory_uri() . '/js/jquery.cycle.all.min.js', array('jquery'),'', true);
  ...
  wp_register_script( 'bootstrap-application', get_template_directory_uri() . '/js/application.min.js', array('jquery'),'', true);
  ...
  wp_register_script( 'superfish', get_template_directory_uri() . '/js/superfish.min.js', array('jquery'),'', true);
