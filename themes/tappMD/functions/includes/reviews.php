...
<div class="row" id="over-slide">
			...
			<div class="span6 overall-score-criterion">
                    ...
                    <ul>	
                       ...
                       <div class="span6 overall-score">
    <div class="row">

                    <div class="span3">
						
                        
                            <h3><?php echo get_post_meta($post->ID, 'csc_overall_title', true); ?></h3>
                    ...
                    <div class="span6" style="background-color:#f8f8f8">
                    <div class="row">
                     
                     
                     <div class="span6 overall-summary" style=" padding-right:0; padding-left:0;" itemprop="description"><?php echo get_post_meta($post->ID, 'csc_overall_score_summary', true); ?>
                     </div>
...
<style>
.overall-score-criterion ul li{ border-bottom: none !important; padding:12px 0 4px !important; min-height:28px;}
</style>
...
<style>
.overall-score-criterion ul li{ border-bottom: none !important; min-height:28px;}
</style>
