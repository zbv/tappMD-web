<!-- slider begin here -->             
<div id="slider_top" class="span6 stp_s">
<?php 
wp_reset_query();
global $post;
$reset_post = $post;
...
#magflexslider.flexslider .slides > li.slideblock{height:401px !important}
</style>
...
<?php endif;?>
  <ul class="slides" style="margin-left:0; margin-bottom:0;height:401px !important">
  ...
  <?php while($featured_query->have_posts()): $featured_query->the_post(); ?>
								...
								<?php if(has_post_thumbnail()): ?>
                                    ...
                                    <?php 
									$images = aq_resize($image, 630, 401 , true, true); //resize & retain image proportions (soft crop)?>
...
global $post;
	$reset_post = $post;
			...
			$recent_posts = new WP_Query('showposts=4&cat='.$categorys); 
			...
			while($recent_posts->have_posts()): $recent_posts->the_post();
			 ...
			 ?>
				...
				<div class="span6 stp_l">
                
                <?php  if(has_post_thumbnail()): ?>
                       
                        <?php $thumb = get_post_thumbnail_id();?>
				        <?php $image = wp_get_attachment_url($thumb, 'full'); ?>
                        <?php $images = aq_resize($image, 659, 210 , true, true);?>
