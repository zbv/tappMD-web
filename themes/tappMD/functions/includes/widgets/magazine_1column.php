 ...
 *Magazine Widget 1
 */
add_action('widgets_init', 'csc_Magazine_1_column_widgets');

function csc_Magazine_1_column_widgets()
{
	register_widget('csc_1_Magazine_Widget');
}

class csc_1_Magazine_Widget extends WP_Widget {
	
	function csc_1_Magazine_Widget()
	{
		$widget_ops = array('classname' => 'csc_magazine', 'description' => '1 Column magazine recent posts widget.');

		$control_ops = array('width' => 250, 'height' => 350,'id_base' => 'csc_magazine-widget');

		$this->WP_Widget('csc_magazine-widget', CSC_NAME .' Magazine 1 Col / 2 Col', $widget_ops, $control_ops);
	}
