<?php
add_action( 'widgets_init', 'csc_login_widget' );
function csc_login_widget() {
...
class login_widget extends WP_Widget {
	...
	function login_widget() {
		...
		$this->WP_Widget( 'login-widget',CSC_NAME .' - Login', $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		$defaults = array( 'text_html_title' =>__('Login' , 'csc-themewp')  );
