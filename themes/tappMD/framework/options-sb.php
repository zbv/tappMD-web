		...
		<div id="sbg_box" class="postbox " >
			...
			<div class="inside">
				<div class="sbg_container">
					...
					<p>Please select the sidebar you would like to display on this post/page ( Sidebar One / Sidebar Two). <strong>Note:</strong> You must first create the sidebar under Appearance > Sidebars.
					</p>
					<ul>
					<?php 
