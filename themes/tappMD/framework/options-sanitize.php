...
//add_filter( 'of_sanitize_sidebar', 'sanitize_text_field' );
...
function of_recognized_font_faces_d() {
	$default = array(
		
		'Arial'=>'Arial', //  array('value', font_url)
	...
	return apply_filters( 'of_recognized_font_faces_d', $default );
}


function of_recognized_font_faces(){
     if(!function_exists('csc_get_google_fonts_array')){
        if(is_file(dirname(__FILE__).'/google-fonts.php')){
             require_once CSC_BASE.'framework/google-fonts.php';
        } 
    }
     ...
     if(!function_exists('csc_get_google_fonts_array')){ 
      ...
      $google_fonts = csc_get_google_fonts_array();
      $font_options = array();
     ...
     return apply_filters( 'of_recognized_font_faces', $font_options);
}
///////////////////////////////////////////////////////////
